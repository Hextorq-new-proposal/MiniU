...
export default function SapMm() {
  return (
      ...
      <div className="container">
        <div className="banner-inner__content">
          <h1>
                        ...
                        Mastering SAP MM – Materials Management Training 
          ...
          <div className="col-lg-8 order-2 order-lg-1">
            <div className="courses-details__item-left">
              <div className="image mb-40">
                <img alt="Course illustration image" src="assets/images/miniu/sap/large/mm.jpg" />
              </div>
              <a className="tag" href="#0">
                SAP
              </a>
              <div className="content mt-30 mb-30">
                ...
                <p className="mb-20">
                  Learn to manage and optimize materials and inventory within an organization. This course covers procurement, inventory management, and material valuation processes to ensure smooth operational workflow. Gain hands-on experience with SAP MM modules, real-world case studies, and practical exercises.
                </p>
              </div>
                    ...
                    <span>
                      <svg fill="none" height="16" viewbox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.38397 14.1797C7.34153 14.1797 7.29954 14.171 7.26066 14.1539C7.22178 14.1369 7.18683 14.1121 7.15803 14.0809L1.06612 7.49119C1.02551 7.44726 0.99859 7.39244 0.988651 7.33344C0.978712 7.27445 0.986187 7.21384 1.01016 7.15902C1.03414 7.10421 1.07357 7.05758 1.12364 7.02483C1.17371 6.99208 1.23223 6.97464 1.29206 6.97464H4.22437C4.26839 6.97464 4.31191 6.98409 4.35197 7.00234C4.39204 7.0206 4.42772 7.04723 4.45661 7.08045L6.49255 9.42273C6.71258 8.95239 7.13852 8.16925 7.88597 7.21497C8.99095 5.8042 11.0463 3.7294 14.5627 1.85642C14.6307 1.82023 14.7097 1.81083 14.7843 1.83009C14.8588 1.84936 14.9235 1.89587 14.9654 1.96046C15.0073 2.02504 15.0235 2.103 15.0108 2.17894C14.998 2.25488 14.9573 2.32328 14.8966 2.37064C14.8831 2.38113 13.5273 3.44882 11.967 5.40448C10.5309 7.20417 8.62191 10.1469 7.68255 13.946C7.66605 14.0128 7.62767 14.0721 7.57354 14.1144C7.5194 14.1568 7.45263 14.1799 7.38388 14.1799L7.38397 14.1797Z" fill="#181818" />
                                        ...
                                        Efficient handling of material master data
                    ...
                    <span>
                      <svg fill="none" height="16" viewbox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.38397 14.1797C7.34153 14.1797 7.29954 14.171 7.26066 14.1539C7.22178 14.1369 7.18683 14.1121 7.15803 14.0809L1.06612 7.49119C1.02551 7.44726 0.99859 7.39244 0.988651 7.33344C0.978712 7.27445 0.986187 7.21384 1.01016 7.15902C1.03414 7.10421 1.07357 7.05758 1.12364 7.02483C1.17371 6.99208 1.23223 6.97464 1.29206 6.97464H4.22437C4.26839 6.97464 4.31191 6.98409 4.35197 7.00234C4.39204 7.0206 4.42772 7.04723 4.45661 7.08045L6.49255 9.42273C6.71258 8.95239 7.13852 8.16925 7.88597 7.21497C8.99095 5.8042 11.0463 3.7294 14.5627 1.85642C14.6307 1.82023 14.7097 1.81083 14.7843 1.83009C14.8588 1.84936 14.9235 1.89587 14.9654 1.96046C15.0073 2.02504 15.0235 2.103 15.0108 2.17894C14.998 2.25488 14.9573 2.32328 14.8966 2.37064C14.8831 2.38113 13.5273 3.44882 11.967 5.40448C10.5309 7.20417 8.62191 10.1469 7.68255 13.946C7.66605 14.0128 7.62767 14.0721 7.57354 14.1144C7.5194 14.1568 7.45263 14.1799 7.38388 14.1799L7.38397 14.1797Z" fill="#181818" />
                                       ...
                                       Learn valuation, reporting, and process integration
                    ...
                    <span>
                      <svg fill="none" height="16" viewbox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.38397 14.1797C7.34153 14.1797 7.29954 14.171 7.26066 14.1539C7.22178 14.1369 7.18683 14.1121 7.15803 14.0809L1.06612 7.49119C1.02551 7.44726 0.99859 7.39244 0.988651 7.33344C0.978712 7.27445 0.986187 7.21384 1.01016 7.15902C1.03414 7.10421 1.07357 7.05758 1.12364 7.02483C1.17371 6.99208 1.23223 6.97464 1.29206 6.97464H4.22437C4.26839 6.97464 4.31191 6.98409 4.35197 7.00234C4.39204 7.0206 4.42772 7.04723 4.45661 7.08045L6.49255 9.42273C6.71258 8.95239 7.13852 8.16925 7.88597 7.21497C8.99095 5.8042 11.0463 3.7294 14.5627 1.85642C14.6307 1.82023 14.7097 1.81083 14.7843 1.83009C14.8588 1.84936 14.9235 1.89587 14.9654 1.96046C15.0073 2.02504 15.0235 2.103 15.0108 2.17894C14.998 2.25488 14.9573 2.32328 14.8966 2.37064C14.8831 2.38113 13.5273 3.44882 11.967 5.40448C10.5309 7.20417 8.62191 10.1469 7.68255 13.946C7.66605 14.0128 7.62767 14.0721 7.57354 14.1144C7.5194 14.1568 7.45263 14.1799 7.38388 14.1799L7.38397 14.1797Z" fill="#181818" />
                                       ...
                                       Real-time problem solving using SAP MM
    ...
    <section className="placement-slider">
      <div className="container">
        <h2 className="placement-title">
          

                    MiniU University Alumni 
          <span>
          ...
          <div className="swiper-wrapper">
            <div className="swiper-slide">
              <div className="placement-card">
                <img alt="Deepak" src="assets/images/miniu/students/deepak.jpg" />
                <h4>
                  DEEPAK
                </h4>
                <p>
            ...
            <div className="swiper-slide">
              <div className="placement-card">
                <img alt="Jayashree" src="assets/images/miniu/students/jayashree.jpg" />
                <h4>
                  JAYASHREE
                </h4>
                <p>
            ...
            <div className="swiper-slide">
              <div className="placement-card">
                <img alt="Nithyasree" src="assets/images/miniu/students/nithyasree.jpg" />
                <h4>
                  NITHYASREE
                </h4>
                <p>
            ...
            <div className="swiper-slide">
              <div className="placement-card">
                <img alt="Vivek Moses" src="assets/images/miniu/students/vivek.jpg" />
                <h4>
                  VIVEK MOSES
                </h4>
                <p>
            ...
            <div className="swiper-slide">
              <div className="placement-card">
                <img alt="Vamsi" src="assets/images/miniu/students/vamsi.jpg" />
                <h4>
                  VAMSI
                </h4>
                <p>
            ...
            <div className="swiper-slide">
              <div className="placement-card">
                <img alt="Rajesh" src="assets/images/miniu/students/rajesh.jpg" />
                <h4>
                  RAJESH
                </h4>
                <p>
            ...
            <div className="swiper-slide">
              <div className="placement-card">
                <img alt="Muthu" src="assets/images/miniu/students/muthu.jpg" />
                <h4>
                  MUTHAMIL SELVAN
                </h4>
                <p>
            ...
            <div className="swiper-slide">
              <div className="placement-card">
                <img alt="Karthik" src="assets/images/miniu/students/karthik.jpg" />
                <h4>
                  KARTHICK
                </h4>
                <p>
        ...
        <div className="swiper courses__slider">
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div className="courses-two__item">
                <div className="courses-two__image image">
                  <img alt="Course illustration image" src="assets/images/miniu/business/small/digital.jpg" />
                </div>
                <div className="courses__content pt-4 p-0">
                  <div className="courses-two__info pb-4">
                    <a href="#">
                  ...
                  <h3>
                    <a className="primary-hover" href="digital_marketing.html">
                      The Complete Digital Marketing Certification Course
                    </a>
                  </h3>
                  <ul className="d-flex align-items-center gap-4 my-3">
                    <li>
            ...
            <div className="swiper-slide">
              <div className="courses-two__item">
                <div className="courses-two__image image">
                  <img alt="Course illustration image" src="assets/images/miniu/development/small/full.jpg" />
                </div>
                <div className="courses__content pt-4 p-0">
                  <div className="courses-two__info pb-4">
                    <a href="#">
                  ...
                  <h3>
                    <a className="primary-hover" href="full_stack.html">
                      Full Stack Web Development – MERN/MEAN Stack Training
                    </a>
                  </h3>
                  <ul className="d-flex align-items-center gap-4 my-3">
                    <li>
