        ...
        <div className="row g-4">
            ...
            <div className="courses-two__item">
              <div className="courses-two__image image">
                <a href="graphic_design.html">
                  <img alt="Course illustration image" src="assets/images/miniu/designing/small/graphic.jpg" />
                </a>
              </div>
              <div className="courses__content pt-4 p-0">
                ...
                <h3>
                  <a className="primary-hover" href="graphic_design.html">
          ...
          <div className="col-xl-4 col-md-6">
            <div className="courses-two__item">
              <div className="courses-two__image image">
                <a href="uiux.html">
                  <img alt="Course illustration image" src="assets/images/miniu/designing/small/uiux.jpg" />
                </a>
              </div>
              <div className="courses__content pt-4 p-0">
                <div className="courses-two__info pb-4">
                ...
                <h3>
                  <a className="primary-hover" href="uiux.html">
