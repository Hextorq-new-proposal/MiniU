          ...
          <div className="col-lg-8 order-2 order-lg-1">
            <div className="courses-details__item-left">
              <div className="image mb-40">
                <img alt="Course illustration image" src="assets/images/miniu/development/large/web.jpg" />
              </div>
              ...
              <div className="content mt-30 mb-30">
                ...
                <p className="mb-20">
                  Learn the essentials of modern web development. Master HTML, CSS, JavaScript, and React to build dynamic, responsive websites.
